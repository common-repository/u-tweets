	...
	private function getTwitterJSON() {
		...
		$utw_options = get_option('utweet');
			$tmhOAuth = new tmhOAuth(array(
				...
				'consumer_key'          => $utw_options['tw_consumer_key'],
				'consumer_secret'       => $utw_options['tw_consumer_secret'],
				'user_token'            => $utw_options['tw_access_token'],
				'user_secret'           => $utw_options['tw_access_secret'],
